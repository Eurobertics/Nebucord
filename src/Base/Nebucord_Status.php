...
abstract class Nebucord_Status {
    ...
    const REST_GUILD_CHANNELS = 'GET_GUILD_CHANNELS';
    const REST_GUILD_LIST_MEMBERS = 'REST_LIST_GUILD_MEMBERS';
    const REST_GUILD_GET_ROLES = 'REST_GUILD_GET_ROLES';
    const REST_USER_CREATE_DM = 'REST_CREATE_DM';
    const REST_CHANNEL_ALL_MESSAGES = 'REST_GET_ALL_CHANNEL_MESSAGES';
    const REST_GUILD_GET_EMOJI = "REST_GET_GUILD_EMOJI";
    const REST_GUILD_GET_ALL_EMOJIS = "GET_GUILD_ALL_EMOJIS";
    const REST_GET_USER = "REST_GET_USER";
    const REST_GET_GUILD = 'REST_GET_GUILD';
    const REST_GUILD_MODIFY_MEMBER = 'REST_GUILD_MODIFY_MEMBER';
    const REST_GUILD_MODIFY_CURRENT_NICK = 'REST_GUILD_MODIFY_CURRENT_NICK';
    const REST_GUILD_ADD_MEMBER_ROLE = 'REST_GUILD_ADD_MEMBER_ROLE';
    const REST_GUILD_REMOVE_MEMBER_ROLE = 'REST_GUILD_REMOVE_MEMBER_ROLE';
    const REST_GET_CHANNEL = 'REST_GET_CHANNEL';
    const REST_CREATE_GUILD_CHANNEL = 'REST_CREATE_GUILD_CHANNEL';
    const REST_MODIFY_CHANNEL_POS = 'REST_MODIFY_CHANNEL_POS';
    const REST_GET_GUILD_MEMBER = 'REST_GET_GUILD_MEMBER';
    const REST_CREATE_GUILD_MEMBER = 'REST_CREATE_GUILD_MEMBER';
    const REST_MODIFY_CURRENT_USER_NICK = 'REST_MODIFY_CURRENT_USER_NICK';
    const REST_GUILD_REMOVE_MEMBER = 'REST_GUILD_REMOVE_MEMBER';
    const REST_GUILD_ADD_MEMBER = 'REST_GUILD_ADD_MEMBER';
    const REST_GUILD_GET_AUDIT_LOGS = 'REST_GUILD_GET_AUDIT_LOGS';
