...
class Nebucord_Status {
    ...
    const REQ_CREATE_MESSAGE = 'CREATE_MESSAGE';
    const REQ_GUILD_CHANNELS = 'GET_GUILD_CHANNELS';
    const REQ_GUILD_LIST_MEMBERS = 'LIST_GUILD_MEMBERS';
    const REQ_GUILD_GET_ROLES = 'REQ_GUILD_GET_ROLES';
    const REQ_USER_CREATE_DM = 'CREATE_DM';
    const REQ_CHANNEL_ALL_MESSAGES = 'GET_ALL_CHANNEL_MESSAGES';
    const REQ_GUILD_GET_EMOJI = "GET_GUILD_EMOJI";
