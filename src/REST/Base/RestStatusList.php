...
abstract class RestStatusList {
	...
	const REST_GET_USER_APPLICATION_ROLE_CONNECTION = 'REST_GET_USER_APPLICATION_ROLE_CONNECTION';
	const REST_UPDATE_USER_APPLICATION_ROLE_CONNECTION = 'REST_UPDATE_USER_APPLICATION_ROLE_CONNECTION';
