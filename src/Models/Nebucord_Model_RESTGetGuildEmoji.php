...
/**
 * Class Nebucord_Model_RESTGetGuildEmoji
 *
 * A model representing a guild emoji request object to a gateway.
 *
 ...
 */
class Nebucord_Model_RESTGetGuildEmoji extends Nebucord_Model implements Nebucord_IModelREST {
    ...
    /**
     * Nebucord_Model_RESTGetGuildEmoji constructor.
     *
     * Sets up the request.
     */
    ...
    /**
     * Nebucord_Model_RESTGetGuildEmoji destructor.
     */
    ...
    public function getApiEndpoint() {
        return "/guilds/".$this->_guildid."/emojis/".$this->_emojiid;
    }
