...
/**
 * Class Nebucord_Model_RESTListGuildEmojis
 *
 * A model representing a guild emoji request object for all emojis to a gateway.
 *
 ...
 */
class Nebucord_Model_RESTListGuildEmojis extends Nebucord_Model implements Nebucord_IModelREST {
    ...
    /**
     * Nebucord_Model_RESTListGuildEmojis constructor.
     *
     * Sets up the request.
     */
    ...
    /**
     * Nebucord_Model_RESTListGuildEmojis destructor.
     */
    ...
    public function getApiEndpoint() {
        return "/guilds/".$this->_guildid."/emojis";
    }
