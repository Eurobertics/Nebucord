...
/**
 * Class Nebucord_Model_OPHello
 *
 * A model representing a hello object to a gateway.
 *
 ...
 */
class Nebucord_Model_OPHello extends Nebucord_Model {

    protected $_heartbeat_interval;
    protected $__trace;

    /**
     * Nebucord_Model_OPHello constructor.
    ...
    /**
     * Nebucord_Model_OPHello destructor.
     *
