...
/**
 * Class Nebucord_Model_RESTListGuildMembers
 *
 * A model representing a list members (for a guild) request object to a gateway.
 *
 ...
 */
class Nebucord_Model_RESTListGuildMembers extends Nebucord_Model implements Nebucord_IModelREST {
    ...
    /**
     * Nebucord_Model_RESTListGuildMembers destructor.
     */
    ...
    public function getApiEndpoint() {
        return "/guilds/".$this->_guildid."/members?limit=".$this->_limit."&after=".$this->_after;
    }
