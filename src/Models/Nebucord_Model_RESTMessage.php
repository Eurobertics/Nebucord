...
/**
 * Class Nebucord_Model_RESTMessage
 *
 * A model representing a message send request object to a gateway.
 *
 ...
 */
class Nebucord_Model_RESTMessage extends Nebucord_Model implements Nebucord_IModelREST {
