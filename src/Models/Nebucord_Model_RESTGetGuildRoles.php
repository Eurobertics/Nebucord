...
/**
 * Class Nebucord_Model_RESTGetGuildRoles
 *
 * A model representing a guild roles request object to a gateway.
 *
 ...
 */
class Nebucord_Model_RESTGetGuildRoles extends Nebucord_Model implements Nebucord_IModelREST {
    ...
    /**
     * Nebucord_Model_RESTGetGuildRoles constructor.
     *
     * Sets up the request.
     */
    ...
    /**
     * Nebucord_Model_RESTGetGuildRoles destructor.
     */
    ...
    public function getApiEndpoint() {
        return "/guilds/".$this->_guildid."/roles";
    }
