...
/**
 * Class Nebucord_Model_RESTGuildAddMemberRole
 *
 ...
 */
class Nebucord_Model_RESTGuildAddMemberRole extends Nebucord_Model implements Nebucord_IModelREST {

    /** @var string $_requesttype The request type needed by this model. */
    private $_requesttype = "PUT";
    ...
    /**
     * Nebucord_Model_RESTGuildAddMemberRole constructor.
     *
     * Sets up the request.
     */
    ...
    /**
     * Nebucord_Model_RESTGuildAddMemberRole destructor.
     */
