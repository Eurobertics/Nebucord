...
/**
 * Class Nebucord_Model_AuditLog
 *
 * A model representing a audit log object from a gateway.
 *
 ...
 */
class Nebucord_Model_AuditLog extends Nebucord_Model {

    protected $_webhooks;
    protected $_users;
    protected $_audit_log_entries;
    protected $_integrations;
    protected $_threads;

    /**
     * Nebucord_Model_AuditLog constructor.
     *
    ...
    /**
     * Nebucord_Model_AuditLog destructor.
     *
